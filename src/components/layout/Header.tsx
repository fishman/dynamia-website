            ...
            <div className="flex justify-between h-16">
              ...
              <div className="hidden lg:ml-8 lg:flex lg:items-center lg:space-x-2 xl:space-x-3">
                ...
                <Link
                  ...
                  className="inline-flex items-center px-3 py-2 border border-primary text-sm font-medium rounded-md text-primary bg-white dark:bg-transparent hover:bg-gray-50 dark:hover:bg-primary/15 whitespace-nowrap"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center px-2 py-2 text-sm font-medium cursor-pointer text-gray-500 hover:text-gray-700 whitespace-nowrap"
                >
