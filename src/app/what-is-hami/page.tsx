                ...
                <div className="flex flex-wrap items-center justify-around">
                  <div className="mb-4 md:mb-0 text-center px-4">
                    <div className="flex items-center justify-center">
                      ...
                      <span className="text-2xl font-bold text-[#76b900]">{t('home.poweredByHami.stats.contributors')}</span>
                    </div>
                  ...
                  <div className="mb-4 md:mb-0 text-center px-4">
                    <div className="flex items-center justify-center">
                      ...
                      <span className="text-2xl font-bold text-[#76b900]">{t('home.poweredByHami.stats.forks')}</span>
                    </div>
                  ...
                  <div className="mb-4 md:mb-0 text-center px-4">
                    <div className="flex items-center justify-center">
                      ...
                      <span className="text-2xl font-bold text-[#76b900]">{t('home.poweredByHami.stats.stars')}</span>
                    </div>
                  ...
                  <div className="mb-4 md:mb-0 text-center px-4">
                    <div className="flex items-center justify-center">
                      ...
                      <span className="text-2xl font-bold text-[#76b900]">{t('home.poweredByHami.stats.commits')}</span>
                    </div>
                  ...
                  <div className="text-center px-4">
                    <div className="flex items-center justify-center">
                      ...
                      <span className="text-2xl font-bold text-[#76b900]">{t('home.poweredByHami.stats.dockerPulls')}</span>
                    </div>
