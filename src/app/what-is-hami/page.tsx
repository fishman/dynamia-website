              ...
              <div className="container">
                <div className="flex flex-wrap items-center justify-around">
                  <div className="mb-4 md:mb-0 text-center px-4">
                    <span className="block text-2xl font-bold text-[#76b900]">{t('home.poweredByHami.stats.contributors')}</span>
                    <span className="text-gray-600 dark:text-gray-300">[ Contributors ]</span>
                  </div>

                  <div className="mb-4 md:mb-0 text-center px-4">
                    <span className="block text-2xl font-bold text-[#76b900]">{t('home.poweredByHami.stats.forks')}</span>
                    <span className="text-gray-600 dark:text-gray-300">[ Forks ]</span>
                  </div>

                  <div className="mb-4 md:mb-0 text-center px-4">
                    <div className="flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#76b900" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                      </svg>
                      <span className="ml-2 text-2xl font-bold text-[#76b900]">{t('home.poweredByHami.stats.stars')}</span>
                    </div>
                  ...
                  <div className="mb-4 md:mb-0 text-center px-4">
                    <div className="flex items-center justify-center">
                      ...
                      <span className="ml-2 text-2xl font-bold text-[#76b900]">{t('home.poweredByHami.stats.commits')}</span>
                    </div>
                    <span className="text-gray-600 dark:text-gray-300">[ Commits ]</span>
                  </div>

                  <div className="text-center px-4">
                    <span className="block text-2xl font-bold text-[#76b900]">{t('home.poweredByHami.stats.pulls')}</span>
