...
hami-ai-platform 服务暴露后，打开站点，确认前后端正常工作。更多产品特性和使用说明详见：TODO。
...
- [HAMi Helm Values Reference](/zh/attachments/hami-helm-values) — HAMi Enterprise Chart 的完整 values 说明
- [Kantaloupe Helm Values Reference](/zh/attachments/kantaloupe-helm-values) — HAMi AI Platform 所用 Kantaloupe Chart 的 `helm-docs` values 说明
